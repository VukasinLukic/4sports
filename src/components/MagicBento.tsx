...
const DEFAULT_GLOW_COLOR = '34, 197, 94'; // Green color rgb(34 197 94)
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(34, 197, 94, 0.3), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(34, 197, 94, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
